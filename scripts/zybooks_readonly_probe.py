...
def _record(raw: dict[str, Any]) -> ActivityRecord:
    ...
    return ActivityRecord(
        ...
        sortable_container_count=int(raw.get("sortable_containers", 0)),
        sortable_item_count=int(raw.get("sortable_items", 0)),
        term_bank_container_count=int(raw.get("term_bank_containers", 0)),
        focusable_custom_item_count=int(raw.get("focusable_custom_items", 0)),
        non_native_draggable_count=int(raw.get("non_native_draggable", 0)),
        drag_drop_roles=_tuple(raw.get("drag_drop_roles")),
        pointer_markers=_tuple(raw.get("pointer_markers")),
        interaction_aria_markers=_tuple(raw.get("interaction_aria_markers")),
